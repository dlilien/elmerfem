...
!
      ...
      !!!!!!!!!!!!!!!!!!!!!!!!
      ! Linear clodure approximation from Advani and Tucker
      ! Eq. 36. Just some combinatorics
      !!!!!!!!!!!!!!!!!!!!!!!!
      subroutine LinA6C(a2,a4,a6)
        USE Types
        implicit none
        Real(dp),dimension(6),intent(in):: a2  
        Real(dp),dimension(9),intent(in):: a4  
        Real(dp),dimension(13),intent(out):: a6
        integer :: i,j,k,l,m,n

        a6 = 0.0_dp
        ! 111111
        a6(1) = 15.0_dp / 693.0_dp &
                - 45.0_dp / 99.0_dp * a2(1) &
                + 15.0_dp / 11.0_dp * a4(1)
        ! 222222
        a6(2) = 15.0_dp / 693.0_dp &
                - 45.0_dp / 99.0_dp * a2(2) &
                + 15.0_dp / 11.0_dp * a4(2)
        ! 111112
        a6(3) = -15.0_dp / 99.0_dp * a2(4) &
                + 10.0_dp / 11.0_dp * a4(7)
        ! 111122
        a6(4) = 3.0_dp / 693.0_dp &
                - 3.0_dp/99.0_dp*(2.0_dp * a2(1) + a2(2)) &
                + 1.0_dp/11.0_dp * (a4(1) + 6.0_dp*a4(3))
        ! 111222
        a6(5) = -9.0_dp/99.0_dp*a2(4) &
                +3.0_dp/11.0_dp*(a4(1)+a4(2))
        ! 112222
        a6(6) = 3.0_dp / 693.0_dp &
                - 3.0_dp/99.0_dp*(a2(1) + 2.0_dp * a2(2)) &
                + 1.0_dp/11.0_dp * (a4(2) + 6.0_dp*a4(3))
        ! 122222
        a6(7) = -15.0_dp / 99.0_dp * a2(4) &
                + 10.0_dp / 11.0_dp * a4(9)
        ! 111113
        a6(8) = -15.0_dp / 99.0_dp * a2(6) &
                + 10.0_dp / 11.0_dp * a4(6)
        ! 111123
        a6(9) = -3.0_dp/99.0_dp * a2(5) &
                + 1.0_dp/11.0_dp * a4(4)
        ! 111223
        a6(10) = -3.0_dp/99.0_dp * a2(6) &
                  + 1.0_dp / 11.0_dp * (a4(6) + 3.0_dp * a4(5))
        ! 112223
        a6(11) = -3.0_dp/99.0_dp * a2(5) &
                  + 1.0_dp / 11.0_dp * (a4(8) + 3.0_dp * a4(4))
        ! 122223
        a6(12) = -3.0_dp/99.0_dp * a2(6) &
                + 1.0_dp/11.0_dp * a4(5)
        ! 222223
        a6(13) = -15.0_dp / 99.0_dp * a2(5) &
                + 10.0_dp / 11.0_dp * a4(8)
      End 
...
!--------------------------------------------------------
      subroutine R2Ro(a2,dim,spoofdim,ai,Euler)
      ...
      Real(dp) :: norm
      integer :: dim, spoofdim               ! dimension  (2D-3D)
      integer :: i,infor 
     ...
     ! normalize
      ...
      subroutine R2Ro_mat(A,ai,Euler)
      ...
      Real(dp),dimension(3),intent(out) :: ai,Euler
      Real(dp),dimension(3,3) :: EigenVec
      Real(dp) :: Dumy(1,3),EI(3),Work(24)
      Real(dp) :: norm
      integer :: dim=3          ! dimension  (2D-3D)
      integer :: i,infor 
